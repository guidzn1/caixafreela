    ...
    <>
      ...
      <div className={`${styles.mobileMenu} ${isMenuOpen ? styles.mobileMenuOpen : ''}`}>
        ...
        <nav className={styles.mobileNav}>
          ...
          <NavLink to="/cofrinhos" className={navLinkClass} onClick={handleCloseMenu}>
            Cofrinhos
          </NavLink>
        </nav>
        ...
        <div className={styles.mobileActions}>
          ...
          {/* NÃO fecha o menu ao alternar tema, para você ver o efeito */}
          <button
            onClick={toggleTheme}
            className={`${styles.mobileButton} ${styles.themeToggleButton}`}
            title="Alterar tema"
          >
          ...
          <button
            onClick={() => { copyPreviousMonth(); handleCloseMenu(); }}
